...
| `docs/experiments/{slug}/`                         | Lightweight `target = prototype` artifacts: experiment card, plus `{iteration}/` subfolders (feature card, visual artifact, acceptance checks, implementation notes, screenshots) |
