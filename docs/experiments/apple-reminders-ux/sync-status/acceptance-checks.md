...
- [x] **Attention without interruption** — When either count is non-zero, the same control is yellow and exposes the combined attention count without a banner, toast, or other main-view notification.
...
- 2026-09-20: Unit tests cover clear/attention semantics, detail counts, activation, and live failed-count updates; Storybook covers the mobile attention flow.
