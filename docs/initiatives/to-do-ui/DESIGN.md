...
| --------------------------------------------------------------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/experiments/{...}/apple-reminders-ui/visual-artifact.md` + `screenshots/` (deleted in Spec 6) | accepted     | **Became the UI reference.** Its values live on in `docs/DESIGN.md`; its picture in the Spec 6 feature doc's Visual Record.                                                                  |
