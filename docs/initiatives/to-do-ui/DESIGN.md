...
| ----------------------------------------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The `apple-reminders-ui` visual artifact + `screenshots/` (deleted in Spec 6) | accepted     | **Became the UI reference.** Its values live on in `docs/DESIGN.md`, its picture in the Spec 6 feature doc, and the experiment itself in `docs/experiments/apple-reminders-ux.md`.           |
