...
| [`docs/DESIGN.md`](../../DESIGN.md)                                                          | Proposed | **Superseded for visual and chrome content.** Not locked, so no re-open ceremony. Spec 6 rewrites it from the shipped production surface. |
| [`docs/initiatives/todo-experience/UX.md`](../todo-experience/UX.md)                         | Proposed | **Superseded for chrome, navigation, and row language.** Its feature-level UX for Sections/ordering/tags survives and is rebased later.   |
