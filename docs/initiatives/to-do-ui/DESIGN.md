...
| ---------------------------------------------------------------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/experiments/archive/apple-reminders-ux/apple-reminders-ui/visual-artifact.md` + `screenshots/` | accepted     | **Becomes the UI reference.** Specs cite it for layout, metrics, and motion.                                                                                                                 |
