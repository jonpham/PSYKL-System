...
| `src/components/TaskCreateForm.tsx` | Create-input form | 6 |
| `src/components/TaskCreateForm.unit.test.tsx` | Unit test for the form (in isolation) | 6 |
| `src/components/TaskCreateForm.component.test.tsx` | Component test: form + API client with MSW stub | 6 |
| `src/components/TaskList.tsx` | List of tasks | 6 |
| `src/components/TaskList.unit.test.tsx` | Unit test for the list (in isolation) | 6 |
| `src/components/TaskList.component.test.tsx` | Component test: list + API client with MSW stub | 6 |
