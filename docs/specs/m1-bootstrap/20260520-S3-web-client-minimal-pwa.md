  ...
  return (
    <main style={{ fontFamily: 'system-ui, sans-serif', padding: '2rem', maxWidth: 640, margin: '0 auto' }}>
      ...
      <section data-testid="task-ui-slot">
        {/* DevTask 6 replaces this slot with TaskCreateForm + TaskList */}
      </section>
    </main>
  );
}
...
const sample: Task[] = [
  { id: '01940000-0000-7000-8000-000000000001', user_id: 'local', title: 'one', created_at: '2026-05-20T12:00:00.000Z' },
  { id: '01940000-0000-7000-8000-000000000002', user_id: 'local', title: 'two', created_at: '2026-05-20T12:01:00.000Z' },
];
