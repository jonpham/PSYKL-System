...
**Initiative status:** 🟡 Active. Specs 1-4 are implemented and await review as a Pull Request stack; Specs 5-6 remain outlined in [`docs/specs/to-do-ui/`](specs/to-do-ui/).
