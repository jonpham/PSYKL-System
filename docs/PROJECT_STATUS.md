...
**Initiative status:** 🟡 Active. Six Specs outlined in [`docs/specs/to-do-ui/`](specs/to-do-ui/); Spec 1 is complete pending review of its stacked Pull Requests.
...
**Active spec for execution:** N/A — `to-do-ui` Spec 1 is written out; its four DevTask Pull Requests await review.
**Current execution:** `to-do-ui` Spec 1/6 is implemented across four stacked Pull Requests — [#100](https://github.com/jonpham/PSYKL-System/pull/100) (merged), [#101](https://github.com/jonpham/PSYKL-System/pull/101), [#103](https://github.com/jonpham/PSYKL-System/pull/103), [#104](https://github.com/jonpham/PSYKL-System/pull/104).

**Next executable work:** `to-do-ui` Spec 2 — Task list and row ([outline](specs/to-do-ui/20260921-Spec2-task-list-and-row.md)). Start with `superpowers:writing-plans` to expand the outline.
**Branch:** `feat/to-do-ui-s1-dt4-lists-page`, the last of the Spec 1 stack.
**Known blockers:** None. The contrast question raised on 2026-09-21 is resolved — the app ships **Standard** (default) and **Increased** contrast as a device-local Settings choice, rather than choosing between Apple's conventional grays and WCAG AA. See [`docs/DESIGN.md`](DESIGN.md) → Contrast — Standard and Increased, and `to-do-ui` DESIGN.md → Decision 5.
