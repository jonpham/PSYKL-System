...
**Next executable spec:** N/A — no specs exist for `todo-experience` yet. `/design-consultation`, `/plan-design-review`, and `/plan-eng-review` run before `superpowers:writing-plans`.
**Active skill:** `/design-consultation` — complete. `/plan-design-review` is next, after visual prototyping.
**Branch:** `feat/plan-psykl-loop`.
**Known blockers:** None. Next action: paste [`PROTOTYPE-PROMPT.md`](initiatives/todo-experience/PROTOTYPE-PROMPT.md) into claude.ai (or ChatGPT / v0 / Stitch) to see and feel the design before committing implementation tokens, then run `/plan-design-review` against [`UX.md`](initiatives/todo-experience/UX.md) with whatever the prototype settled.
...
1. **Read in this order:**
   ...
   - [`docs/initiatives/todo-experience/DESIGN.md`](initiatives/todo-experience/DESIGN.md) — the active initiative design; next run `/design-consultation`
...
| ~~Todo UX user stories, dense-list interaction design, and Apple Reminders comparison bar~~ — **ANSWERED 2026-08-13** by `/design-consultation`. See [`UX.md`](initiatives/todo-experience/UX.md) (stories, gesture vocabulary, empty states, comparison bar) and [`docs/DESIGN.md`](DESIGN.md) (visual system). Seven open questions carried to `/plan-design-review`. | [`UX.md`](initiatives/todo-experience/UX.md) § 10 | `todo-experience`   |
