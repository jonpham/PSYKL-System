...
**Current execution:** `to-do-ui` Spec 1/6, DevTask 3/4 — header sync control and the remaining destinations on `feat/to-do-ui-s1-dt3-sync-control`, stacked on PR #101.

**Next executable work:** DevTask 4 — the Lists page, which also deletes `ListSwitcher` ([implementation spec](specs/to-do-ui/20260921-Spec1-shell-navigation-and-lists.md)).
**Branch:** `feat/to-do-ui-s1-dt3-sync-control`, stacked on DevTask 2 PR #101.
