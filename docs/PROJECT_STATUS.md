...
**Active spec for execution:** N/A — `to-do-ui` Specs 1-5 are merged; Spec 6 is next.
**Current execution:** `to-do-ui` Specs 1-5 are merged to `main` via the thirteen-deep DevTask stack ([#100](https://github.com/jonpham/PSYKL-System/pull/100)-[#113](https://github.com/jonpham/PSYKL-System/pull/113), [#115](https://github.com/jonpham/PSYKL-System/pull/115)) plus the ordering-defect fix [#119](https://github.com/jonpham/PSYKL-System/pull/119). Released as v0.5.0.
