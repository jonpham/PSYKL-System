...
**Known blockers:** None. Next action: run `/design-consultation` against `docs/initiatives/todo-experience/DESIGN.md` in a clean Codex session or new Claude Code session.
...
| Todo UX user stories, dense-list interaction design, and Apple Reminders comparison bar                                                                                                                                                                                                                    | `/design-consultation` next               | `todo-experience`   |
