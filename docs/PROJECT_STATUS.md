...
**Next executable work:** Merge [PR #132](https://github.com/jonpham/PSYKL-System/pull/132) with operator approval; then `to-do-ui` Spec 6 — retire the experiment and close out the initiative ([outline](specs/to-do-ui/20260921-Spec6-retire-experiment-and-close-out.md)).
**Branch:** `feat/123-experiment-tools-toggles`.
