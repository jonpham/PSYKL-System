...
**Active spec for execution:** N/A. The lightweight production change for [#124](https://github.com/jonpham/PSYKL-System/issues/124) — in-app PWA update from Settings → About — is consolidated in its [feature doc](features/%5B20260922%5DGH124_to-do-ui-in-app-pwa-update.md); its artifact folder was deleted at close-out. The parity change for [#122](https://github.com/jonpham/PSYKL-System/issues/122) merged as [PR #130](https://github.com/jonpham/PSYKL-System/pull/130).
**Current execution:** #124 is implemented, operator-approved on device, and covered at every test layer (unit, Storybook component, E2E). Awaiting review. `to-do-ui` Specs 1-5 are merged and released as v0.5.0.

**Next executable work:** Review and merge the #124 PR with operator approval; then `to-do-ui` Spec 6 — retire the experiment and close out the initiative ([outline](specs/to-do-ui/20260921-Spec6-retire-experiment-and-close-out.md)).
