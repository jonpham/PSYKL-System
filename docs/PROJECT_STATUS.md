...
**Active spec for execution:** N/A. The lightweight production change for [#125](https://github.com/jonpham/PSYKL-System/issues/125) — PSYKL logo and app identity — is complete and consolidated in its [feature doc](features/%5B20260922%5DGH125_to-do-ui-psykl-logo-and-app-identity.md); its artifact folder was deleted at close-out. Recently merged: the 🧪 experience switcher for [#123](https://github.com/jonpham/PSYKL-System/issues/123) as [PR #132](https://github.com/jonpham/PSYKL-System/pull/132), the in-app PWA update for [#124](https://github.com/jonpham/PSYKL-System/issues/124) as [PR #131](https://github.com/jonpham/PSYKL-System/pull/131), and the parity change for [#122](https://github.com/jonpham/PSYKL-System/issues/122) as [PR #130](https://github.com/jonpham/PSYKL-System/pull/130).
**Current execution:** None. #125 is implemented, operator-approved on device (including the iOS home-screen tile following Settings → Appearance), covered at every test layer (unit, Storybook component, E2E), and documented; [PR #133](https://github.com/jonpham/PSYKL-System/pull/133) carries the whole change including its docs, so merging it is the last step. `to-do-ui` Specs 1-5 are merged and released as v0.5.0.

**Next executable work:** Merge [PR #133](https://github.com/jonpham/PSYKL-System/pull/133) with operator approval; then `to-do-ui` Spec 6 — retire the experiment and close out the initiative ([outline](specs/to-do-ui/20260921-Spec6-retire-experiment-and-close-out.md)).
**Branch:** `feat/125-psykl-logo`.
