...
**Active spec for execution:** `to-do-ui` Spec 1 — Shell, Navigation, and List Management.
**Current execution:** `to-do-ui` Spec 1/6, DevTask 2/4 — responsive app shell and sidebar navigation on `feat/to-do-ui-s1-dt2-app-shell`, stacked on PR #100.

**Next executable work:** Verify and publish DevTask 2 as a stacked PR targeting `feat/to-do-ui-s1-dt1-foundation` ([implementation spec](specs/to-do-ui/20260921-Spec1-shell-navigation-and-lists.md)).
**Branch:** `feat/to-do-ui-s1-dt2-app-shell`, stacked on DevTask 1 PR #100.
