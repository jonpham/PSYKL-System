...
**Initiative status:** 🟡 Active. Specs 1 and 2 are implemented and await review as a Pull Request stack; Specs 3-6 remain outlined in [`docs/specs/to-do-ui/`](specs/to-do-ui/).
...
**Active spec for execution:** N/A — `to-do-ui` Specs 1 and 2 are written out; their six DevTask Pull Requests await review.
**Current execution:** `to-do-ui` Specs 1-2/6 are implemented across a six-deep Pull Request stack — [#100](https://github.com/jonpham/PSYKL-System/pull/100) (merged), [#101](https://github.com/jonpham/PSYKL-System/pull/101), [#103](https://github.com/jonpham/PSYKL-System/pull/103), [#104](https://github.com/jonpham/PSYKL-System/pull/104), [#105](https://github.com/jonpham/PSYKL-System/pull/105), [#106](https://github.com/jonpham/PSYKL-System/pull/106).

**Next executable work:** `to-do-ui` Spec 3 — Inline capture ([outline](specs/to-do-ui/20260921-Spec3-inline-capture.md)).
**Branch:** `feat/to-do-ui-s2-dt5-task-list`, the tip of the stack.
