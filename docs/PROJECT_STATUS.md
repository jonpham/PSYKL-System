...
**Initiative status:** 🟡 Active. Specs 1-3 are implemented and await review as a Pull Request stack; Specs 4-6 remain outlined in [`docs/specs/to-do-ui/`](specs/to-do-ui/).
...
**Active spec for execution:** N/A — `to-do-ui` Specs 1-3 are written out; their eight DevTask Pull Requests await review.
**Current execution:** `to-do-ui` Specs 1-3/6 are implemented across an eight-deep Pull Request stack — [#100](https://github.com/jonpham/PSYKL-System/pull/100) (merged), [#101](https://github.com/jonpham/PSYKL-System/pull/101), [#103](https://github.com/jonpham/PSYKL-System/pull/103), [#104](https://github.com/jonpham/PSYKL-System/pull/104), [#105](https://github.com/jonpham/PSYKL-System/pull/105), [#106](https://github.com/jonpham/PSYKL-System/pull/106), [#107](https://github.com/jonpham/PSYKL-System/pull/107), [#108](https://github.com/jonpham/PSYKL-System/pull/108).

**Next executable work:** `to-do-ui` Spec 4 — List options and completed visibility ([outline](specs/to-do-ui/20260921-Spec4-list-options-and-completed-visibility.md)).
**Branch:** `feat/to-do-ui-s3-dt7-retire-create-form`, the tip of the stack.
